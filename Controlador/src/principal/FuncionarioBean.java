...
public class FuncionarioBean {
    ...
    public FuncionarioBean(String cog, String name, String mail, String cel, int type, String log, String pass) {
        codigo = cog;
        nome = name;
        email = mail;
        celular = cel;
    ...
    public FuncionarioBean(String cog, String name, String mail, String cel, int type) {
    ...
    public boolean equals(Object o) {
    	if (this.getCodigo().equals(((FuncionarioBean)o).getCodigo())) {
    		return true;
    	}
    	return false;
    }
